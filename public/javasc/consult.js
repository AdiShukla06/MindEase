...
// const couplequesbox = document.getElementById("couplequesbox");
// const coupleques = document.getElementById("coupleques");

// const couple_btn = document.getElementById("couple_btn");

// couple_btn.addEventListener("click", function(){
//   first_question.classList.add("hidden");
//   couplequesbox.classList.remove("hidden");

// })
// const quesbox2 = document.getElementById("quesbox2");
// const coupleques2 = document.getElementById("coupleques2");

// const couplebtn = document.querySelectorAll(".couplebtn");

// couplebtn.forEach(button => {
//   button.addEventListener("click", function(){
//     couplequesbox.classList.toggle("hidden");
//     quesbox2.classList.toggle("hidden");
//     coupleques2.classList.toggle("hidden");
//     coupleques2.classList.toggle("hidden");
//     couplebtn.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
// })
// const quesbox3 = document.getElementById("quesbox3");
// const coupleques3 = document.getElementById("coupleques3");

// const couplebtn2 = document.querySelectorAll(".couplebtn2");

// couplebtn2.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox2.classList.toggle("hidden");
//     quesbox3.classList.toggle("hidden");
//     coupleques2.classList.toggle("hidden");
//     coupleques3.classList.remove("hidden");
//     couplebtn2.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
// })
// const quesbox4 = document.getElementById("quesbox4");
// const coupleques4 = document.getElementById("coupleques4");

// const couplebtn3 = document.querySelectorAll(".couplebtn3");

// couplebtn3.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox3.classList.toggle("hidden");
//     quesbox4.classList.toggle("hidden");
//     coupleques3.classList.toggle("hidden");
//     coupleques4.classList.remove("hidden");
//     couplebtn3.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
// })
// const quesbox5 = document.getElementById("quesbox5");
// const coupleques5 = document.getElementById("coupleques5");

// const couplebtn4 = document.querySelectorAll(".couplebtn4");

// couplebtn4.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox4.classList.toggle("hidden");
//     quesbox5.classList.toggle("hidden");
//     coupleques4.classList.toggle("hidden");
//     coupleques5.classList.remove("hidden");
//     couplebtn4.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
// })
// const quesbox6 = document.getElementById("quesbox6");
// const coupleques6 = document.getElementById("coupleques6");

// const couplebtn5 = document.querySelectorAll(".couplebtn5");

// couplebtn5.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox5.classList.toggle("hidden");
//     quesbox6.classList.toggle("hidden");
//     coupleques5.classList.toggle("hidden");
//     coupleques6.classList.remove("hidden");
//     couplebtn5.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
// })
// const quesbox7 = document.getElementById("quesbox7");
// const coupleques7 = document.getElementById("coupleques7");

// const couplebtn6 = document.querySelectorAll(".couplebtn6");

// couplebtn6.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox6.classList.toggle("hidden");
//     quesbox7.classList.toggle("hidden");
//     coupleques6.classList.toggle("hidden");
//     coupleques7.classList.remove("hidden");
//     couplebtn6.forEach(button => {
//       button.classList.toggle("hidden");
//     })
//   })
...
// const couplebtn7 = document.querySelectorAll(".couplebtn7");

// couplebtn7.forEach(button => {
//   button.addEventListener("click", function(){
//     quesbox7.classList.toggle("hidden");
//     couplebtn7.forEach(button => {
//       button.classList.toggle("hidden");
...
// const teenquesbox = document.getElementById("teenquesbox");
// const teenques = document.getElementById("teenques");

// const teen_btn = document.getElementById("teen_btn");

// teen_btn.addEventListener("click", function(){
//   first_question.classList.add("hidden");
//   teenquesbox.classList.remove("hidden");

// })

// const teenquesbox2 = document.getElementById("teenquesbox2");
// const teenques2 = document.getElementById("teenques2");

// const teenbtn = document.querySelectorAll(".teenbtn");

// teenbtn.forEach(button => {
//   button.addEventListener("click", function(){
//     teenquesbox2.classList.remove("hidden");
//     teenques2.classList.remove("hidden");
//     teenquesbox.classList.add("hidden");
//     teenbtn.forEach(button => {
//       button.classList.add("hidden")
//     })
//   })
// })
// const teenquesbox3 = document.getElementById("teenquesbox3");
// const teenques3 = document.getElementById("teenques3");

// const teenbtn2 = document.querySelectorAll(".teenbtn2");

// teenbtn2.forEach(button => {
//   button.addEventListener("click", function(){
//     window.location.href = '/signin';
//   })
// })
